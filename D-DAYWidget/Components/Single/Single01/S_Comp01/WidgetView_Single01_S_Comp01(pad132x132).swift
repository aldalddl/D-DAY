//
//  WidgetView_Single01_S_Comp01(pad132x132).swift
...
struct WidgetView_Single01_S_Comp01_pad132x132_: View { // disable shadow
                ...
                ZStack() {
                    ...
                    case ...3:
                        Text(ddaySymbolMenu[safe: 0]?.ddayTitle ?? localizedKey.stringValue())
                            ...
                            .position(x: metrics.size.width * 0.68, y: metrics.size.height * 0.335)
                    ...
                    case 5...10:
                        Text(ddaySymbolMenu[safe: 0]?.ddayTitle ?? localizedKey.stringValue())
                            ...
                            .position(x: metrics.size.width * 0.715, y: metrics.size.height * 0.31)
                    ...
                    case 11...14:
                        Text(ddaySymbolMenu[safe: 0]?.ddayTitle ?? localizedKey.stringValue())
                            ...
                            .position(x: metrics.size.width * 0.703, y: metrics.size.height * 0.3)
