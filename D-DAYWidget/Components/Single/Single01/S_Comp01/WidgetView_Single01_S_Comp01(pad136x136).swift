//
//  WidgetView_Single01_S_Comp01(pad136x136).swift
...
struct WidgetView_Single01_S_Comp01_pad136x136_: View { // disable shadow
            ...
            ZStack() {
                ...
                case "D":
                    Text("D")
                        ...
                        .font(.custom("Inter-Bold", size: 102))
                ...
                case "+":
                    Text("+")
                        .position(x: 10, y: -38)
                        .frame(width: 85, height: 36, alignment: .leading)
                        .font(.custom("Inter-Bold", size: 138))
                        .rotationEffect(.degrees(-13))
                        .multilineTextAlignment(.leading)
            ...
            GeometryReader { metrics in
                ZStack() {
                    ...
                    case 4:
                        Text(ddaySymbolMenu[safe: 0]?.ddayTitle ?? localizedKey.stringValue())
                            .frame(width: 60, height: 50, alignment: .topTrailing)
                            .position(x: metrics.size.width * 0.705, y: metrics.size.height * 0.34)
                    ...
                    case 5...10:
                        Text(ddaySymbolMenu[safe: 0]?.ddayTitle ?? localizedKey.stringValue())
                            ...
                            .position(x: metrics.size.width * 0.715, y: metrics.size.height * 0.32)
                    ...
                    case 11...14:
                        Text(ddaySymbolMenu[safe: 0]?.ddayTitle ?? localizedKey.stringValue())
                            ...
                            .position(x: metrics.size.width * 0.703, y: metrics.size.height * 0.313)
