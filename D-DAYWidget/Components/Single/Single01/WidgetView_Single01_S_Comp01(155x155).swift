//
//  WidgetView_Single01_S_Comp01(155x155).swift
...
struct WidgetView_Single01_S_Comp01_155x155_: View { // disable shadow
                ...
                ZStack() {
                    ...
                    case 11...14:
                        Text(ddaySymbolMenu[safe: 0]?.ddayTitle ?? localizedKey.stringValue())
                            ...
                            .position(x: metrics.size.width * 0.71, y: metrics.size.height * 0.40)
