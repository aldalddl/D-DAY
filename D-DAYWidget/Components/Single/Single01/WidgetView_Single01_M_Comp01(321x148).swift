//
//  WidgetView_Single01_M_Comp01(321x148).swift
...
struct WidgetView_Single01_M_Comp01_321x148_: View {// disable shadow
                ...
                GeometryReader { metrics in
                    ...
                    case ...5:
                        Text(ddaySymbolMenu[safe: 0]?.ddayTitle ?? localizedKey.stringValue())
                            ...
                            .position(x: metrics.size.width * 0.386, y: metrics.size.height * 0.27)
                    ...
                    case 11...14:
                        Text(ddaySymbolMenu[safe: 0]?.ddayTitle ?? localizedKey.stringValue())
                            ...
                            .frame(width: 200, height: 20, alignment: .topLeading)
                            .position(x: metrics.size.width * 0.37, y: metrics.size.height * 0.272)
