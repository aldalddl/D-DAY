//
//  WidgetView_Single01_S_Comp02(169x169).swift
...
struct WidgetView_Single01_S_Comp02_169x169_: View { // enable shadow
            ...
            ZStack() {
                ...
                case "+":
                    Text("+")
                        ...
                        .shadow(color: Color("ddayBlack").opacity(0.3), radius: 2.2, x: 0.6, y: 4)
                        .font(.custom("Inter-Bold", size: 147))
                        .rotationEffect(.degrees(-13))
                        .multilineTextAlignment(.leading)
