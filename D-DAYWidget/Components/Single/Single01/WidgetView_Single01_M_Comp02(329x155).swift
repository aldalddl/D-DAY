//
//  WidgetView_Single01_M_Comp02(329x155).swift
...
struct WidgetView_Single01_M_Comp02_329x155_: View { // enable shadow
                ...
                GeometryReader { metrics in
                    ...
                    case ...5:
                        Text(ddaySymbolMenu[safe: 0]?.ddayTitle ?? localizedKey.stringValue())
                            ...
                            .position(x: metrics.size.width * 0.388, y: metrics.size.height * 0.26)
