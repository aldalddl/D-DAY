//
//  WidgetView_Single01_M_Comp01(360x169).swift
...
struct WidgetView_Single01_M_Comp01_360x169_: View { // disable shadow
                ...
                GeometryReader { metrics in
                    ...
                    case 11...14:
                        Text(ddaySymbolMenu[safe: 0]?.ddayTitle ?? localizedKey.stringValue())
                            ...
                            .frame(width: 200, height: 20, alignment: .topLeading)
                            .position(x: metrics.size.width * 0.33, y: metrics.size.height * 0.224)
