//
//  WidgetView_Single02_L_Comp01(pad132x132).swift
...
struct WidgetView_Single02_L_Comp01_pad132x132_: View { // disable shadow
        ...
        ZStack {
            ZStack {
                ...
                Text(ddaySymbolMenu[safe: 0]?.ddayDate ?? "2024.12.25")
                    ...
                    .padding(EdgeInsets(top: 0, leading: 157, bottom: 70, trailing: 0))
                    .multilineTextAlignment(.trailing)
                    .lineSpacing(2)
                    .foregroundColor(Color(hex: ddaySymbolMenu[safe: 0]?.ddayTxtColor ?? "ddayBlack"))
