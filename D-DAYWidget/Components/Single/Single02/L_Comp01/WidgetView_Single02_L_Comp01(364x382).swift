//
//  WidgetView_Single02_L_Comp01(364x170).swift
...
struct WidgetView_Single02_L_Comp01_364x382_: View { // disable shadow
        ...
        ZStack {
            ZStack {
                ...
                Text(ddaySymbolMenu[safe: 0]?.ddayDate ?? "2023.12.28")
                    ...
                    .padding(EdgeInsets(top: 0, leading: 193, bottom: 85, trailing: 0))
                    .multilineTextAlignment(.trailing)
                    .lineSpacing(2)
                    .foregroundColor(Color(hex: ddaySymbolMenu[safe: 0]?.ddayTxtColor ?? "ddayBlack"))
