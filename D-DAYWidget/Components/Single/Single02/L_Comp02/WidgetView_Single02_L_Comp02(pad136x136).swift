//
//  WidgetView_Single02_L_Comp02(pad136x136).swift
...
struct WidgetView_Single02_L_Comp02_pad136x136_: View { // enable shadow
        ...
        ZStack {
            ZStack {
                ...
                Text(ddaySymbolMenu[safe: 0]?.ddayDate ?? "2024.12.25")
                    ...
                    .padding(EdgeInsets(top: 0, leading: 159, bottom: 68, trailing: 0))
                    .multilineTextAlignment(.trailing)
                    .lineSpacing(2)
                    .foregroundColor(Color(hex: ddaySymbolMenu[safe: 0]?.ddayTxtColor ?? "ddayBlack"))
