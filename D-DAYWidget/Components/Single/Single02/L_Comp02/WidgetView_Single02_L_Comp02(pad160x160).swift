//
//  WidgetView_Single02_L_Comp02(pad160x160).swift
...
struct WidgetView_Single02_L_Comp02_pad160x160_: View { // enable shadow
        ...
        ZStack {
            ZStack {
                ...
                Text(ddaySymbolMenu[safe: 0]?.ddayDate ?? "2024.12.25")
                    ...
                    .padding(EdgeInsets(top: 0, leading: 196, bottom: 86, trailing: 0))
                    .multilineTextAlignment(.trailing)
                    .lineSpacing(2)
                    .foregroundColor(Color(hex: ddaySymbolMenu[safe: 0]?.ddayTxtColor ?? "ddayBlack"))
