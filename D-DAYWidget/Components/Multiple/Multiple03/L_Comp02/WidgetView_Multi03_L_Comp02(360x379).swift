...
struct WidgetView_Multi03_L_Comp02_360x379_: View { // enable shadow
    ...
    var body: some View {
            ...
            ZStack {
                ...
                case 0...6:
                    Text(ddaySymbolMenu[safe: 0]?.ddayTitle ?? localizedKey.stringValue())
                        ...
                        .padding(EdgeInsets(top: 0, leading: 0, bottom: 238, trailing: 6))
                ...
                case 7...10:
                    Text(ddaySymbolMenu[safe: 0]?.ddayTitle ?? localizedKey.stringValue())
                        ...
                        .multilineTextAlignment(.trailing)
                        .padding(EdgeInsets(top: 0, leading: 2, bottom: 238, trailing: 0))
                        .foregroundColor(Color(hex: ddaySymbolMenu[safe: 0]?.ddayBgColor ?? "ddayBlack"))
                ...
                case 11...14:
                    Text(ddaySymbolMenu[safe: 0]?.ddayTitle ?? localizedKey.stringValue())
                        ...
                        .multilineTextAlignment(.trailing)
                        .padding(EdgeInsets(top: 0, leading: 0, bottom: 238, trailing: 2))
                        .foregroundColor(Color(hex: ddaySymbolMenu[safe: 0]?.ddayBgColor ?? "ddayBlack"))
            ...
            let dateInt3: Int = CustomFunctions().calculateDday(ddayRecievedDate: (ddaySymbolMenu[safe: 2]?.ddayDate ??  "2025.04.02"), isTodayCounted: isTodayCounted3)
