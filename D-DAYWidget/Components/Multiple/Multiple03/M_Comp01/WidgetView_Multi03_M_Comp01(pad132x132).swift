//
//  WidgetView_Multi03_M_Comp01(pad132x132).swift
...
struct WidgetView_Multi03_M_Comp01_pad132x132_: View { // disable shadow
    ...
    var body: some View {
        ...
        ZStack{
            ...
            .frame(width: 187, height: 55)
            .background(Color(hex: ddaySymbolMenu[safe: 0]?.ddayTxtColor ?? "ddayBlack"))
            .position(x: 265, y: 136)
