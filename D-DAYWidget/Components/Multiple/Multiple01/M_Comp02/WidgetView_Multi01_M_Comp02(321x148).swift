//
//  WidgetView_Multi01_M_Comp02(321x148).swift
...
struct WidgetView_Multi01_M_Comp02_321x148_: View { // enable shadow
            ...
            HStack(alignment: .bottom, spacing: 0) {
                ZStack(alignment: .bottom) {
                    ...
                    Text(ddaySymbolMenu[safe: 0]?.ddayDate ?? "0000.00.00")
                        ...
                        .frame(width: 22, height: 50, alignment: .topLeading)
                        .position(x: 40, y: 127)
                        .foregroundColor(Color(hex: ddaySymbolMenu[safe: 0]?.ddayTxtColor ?? "ddayWhite"))
                    ...
                    .frame(width: 124, height: 44, alignment: .bottomTrailing)
                ...
                ZStack(alignment: .bottom) {
                    ...
                    Text(ddaySymbolMenu[safe: 1]?.ddayDate ?? "0000.00.00")
                        .font(.custom("Inter-Bold", size: 7.0))
                        .multilineTextAlignment(.leading)
                        .frame(width: 22, height: 50, alignment: .topTrailing)
                    ...
                    .frame(width: 124, height: 44, alignment: .bottomLeading)
