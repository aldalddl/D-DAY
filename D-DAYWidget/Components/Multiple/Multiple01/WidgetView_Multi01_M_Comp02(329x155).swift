//
//  WidgetView_Multi01_M_Comp02(329x155).swift
...
struct WidgetView_Multi01_M_Comp02_329x155_: View { // enable shadow
        ...
        VStack(spacing: 0) {
            HStack(alignment: .bottom, spacing: 0) {
                ZStack(alignment: .bottom) {
                    ...
                    .frame(width: 125, height: 49, alignment: .bottomTrailing)
                ...
                ZStack(alignment: .bottom) {
                    ...
                    .frame(width: 125, height: 49, alignment: .bottomLeading)
