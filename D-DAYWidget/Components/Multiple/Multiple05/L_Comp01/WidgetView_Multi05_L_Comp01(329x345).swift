//
//  WidgetView_Multi05_L_Comp01(329x345).swift
...
struct WidgetView_Multi05_L_Comp01_329x345_: View { // disable shadow
            ...
            ZStack {
                ...
                case 5...6:
                    Text(ddaySymbolMenu[safe: 0]?.ddayTitle ?? localizedKey.stringValue())
                        ...
                        .frame(width: 80, height: 55, alignment: .topTrailing)
                        .multilineTextAlignment(.trailing)
                        .padding(EdgeInsets(top: 16, leading: 220, bottom: 0, trailing: 0))
                        .lineLimit(3)
                        .foregroundColor(Color(hex: ddaySymbolMenu[safe: 0]?.ddayBgColor ?? "ddayBlack"))
                ...
                case 11...14:
                    Text(ddaySymbolMenu[safe: 0]?.ddayTitle ?? localizedKey.stringValue())
                        ...
                        .multilineTextAlignment(.trailing)
                        .padding(EdgeInsets(top: 5, leading: 208, bottom: 0, trailing: 0))
                        .lineLimit(3)
                        .foregroundColor(Color(hex: ddaySymbolMenu[safe: 0]?.ddayBgColor ?? "ddayBlack"))
                ...
                Text(ddaySymbolMenu[safe: 0]?.ddayDate ?? "2000.00.00")
                    ...
                    .padding(EdgeInsets(top: 75, leading: 227, bottom: 0, trailing: 0))
                    .foregroundColor(Color(hex: ddaySymbolMenu[safe: 0]?.ddayBgColor ?? "ddayBlack"))
            }
            ...
            ZStack {
                ...
                case ...3:
                    Text(ddaySymbolMenu[safe: 1]?.ddayTitle ?? localizedKey.stringValue())
                        ...
                        .padding(EdgeInsets(top: 13, leading: 0, bottom: 0, trailing: 215))
                        .lineLimit(3)
                        .foregroundColor(Color(hex: ddaySymbolMenu[safe: 0]?.ddayTxtColor ?? "ddayWhite"))
                ...
                case 5...6:
                    Text(ddaySymbolMenu[safe: 1]?.ddayTitle ?? localizedKey.stringValue())
                        ...
                        .frame(width: 80, height: 55, alignment: .topLeading)
                        .multilineTextAlignment(.leading)
                        .padding(EdgeInsets(top: 14, leading: 0, bottom: 0, trailing: 215))
                        .lineLimit(3)
                        .foregroundColor(Color(hex: ddaySymbolMenu[safe: 0]?.ddayTxtColor ?? "ddayWhite"))
                ...
                case 7...10:
                    ...
                    .frame(width: 80, height: 55, alignment: .topLeading)
                    .multilineTextAlignment(.leading)
                    .padding(EdgeInsets(top: 2, leading: 0, bottom: 0, trailing: 215))
                    .lineLimit(3)
                    .foregroundColor(Color(hex: ddaySymbolMenu[safe: 0]?.ddayTxtColor ?? "ddayWhite"))
                ...
                case 11...14:
                    Text(ddaySymbolMenu[safe: 1]?.ddayTitle ?? localizedKey.stringValue())
                        ...
                        .frame(width: 90, height: 55, alignment: .topTrailing)
                        .multilineTextAlignment(.leading)
                        .padding(EdgeInsets(top: 4, leading: 0, bottom: 0, trailing: 206))
                        .lineLimit(3)
                        .foregroundColor(Color(hex: ddaySymbolMenu[safe: 0]?.ddayTxtColor ?? "ddayWhite"))
                ...
                case 15...:
                    Text(ddaySymbolMenu[safe: 1]?.ddayTitle ?? localizedKey.stringValue())
                        ...
                        .frame(width: 80, height: 55, alignment: .topTrailing)
                        .multilineTextAlignment(.leading)
                        .padding(EdgeInsets(top: 4, leading: 0, bottom: 0, trailing: 215))
                        .lineLimit(3)
                        .foregroundColor(Color(hex: ddaySymbolMenu[safe: 0]?.ddayTxtColor ?? "ddayWhite"))
                default:
                ...
                Text(ddaySymbolMenu[safe: 1]?.ddayDate ?? "2000.00.00")
                    ...
                    .padding(EdgeInsets(top: 77, leading: 0, bottom: 0, trailing: 225))
                    .foregroundColor(Color(hex: ddaySymbolMenu[safe: 0]?.ddayTxtColor ?? "ddayWhite"))
            }
            .frame(width: 400, height: 80)
