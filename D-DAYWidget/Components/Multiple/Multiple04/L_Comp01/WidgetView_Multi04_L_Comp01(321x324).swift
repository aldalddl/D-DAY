            ...
            ZStack {
                ...
                case ...3:
                    Text(ddaySymbolMenu[safe: 0]?.ddayTitle ?? localizedKey.stringValue())
                        ...
                        .padding(EdgeInsets(top: 0, leading: 0, bottom: 213, trailing: 4))
                ...
                case 4:
                    Text(ddaySymbolMenu[safe: 0]?.ddayTitle ?? localizedKey.stringValue())
                        ...
                        .frame(width: 70, height: 55, alignment: .topTrailing)
                        .multilineTextAlignment(.trailing)
                        .padding(EdgeInsets(top: 0, leading: 0, bottom: 213, trailing: 0))
                        .foregroundColor(Color(hex: ddaySymbolMenu[safe: 0]?.ddayBgColor ?? "ddayBlack"))
                ...
                Text(ddaySymbolMenu[safe: 0]?.ddayDate ?? "2000.00.00")
                    ...
                    .padding(EdgeInsets(top: 0, leading: 0, bottom: 113, trailing: 0))
                    .foregroundColor(Color(hex: ddaySymbolMenu[safe: 0]?.ddayBgColor ?? "ddayBlack"))
