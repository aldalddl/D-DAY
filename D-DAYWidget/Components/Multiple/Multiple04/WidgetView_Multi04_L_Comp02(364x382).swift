//
//  WidgetView_Multi04_L_Comp02(364x382).swift
...
struct WidgetView_Multi04_L_Comp02_364x382_: View { // enable shadow
        ...
        HStack(spacing: 25) {
            ...
            ZStack {
                ...
                Text(ddaySymbolMenu[safe: 0]?.ddayDate ?? "2000.00.00")
                    ...
                    .padding(EdgeInsets(top: 0, leading: 0, bottom: 155, trailing: 0))
                    .foregroundColor(Color(hex: ddaySymbolMenu[safe: 0]?.ddayBgColor ?? "ddayBlack"))
                ...
                case ...3:
                    Text("\(CustomFunctions().makeSignedDateNumber(dateIntParam: CustomFunctions().calculateDday(ddayRecievedDate: (ddaySymbolMenu[safe: 0]?.ddayDate ??  "2023.10.16"), isTodayCounted: ddaySymbolMenu[safe: 0]?.ddayIsCountdown ?? "false")))")
                        ...
                        .padding(EdgeInsets(top: 50, leading: 0, bottom: 27, trailing: 10))
                        .kerning(-10)
